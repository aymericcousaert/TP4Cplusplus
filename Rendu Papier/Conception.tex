...
\hline
\bf Spécifications &\bf Erreur fournie & \bf Tests adapés \\

\hline
Fonctionnement normal avec ou sans options & Aucune & 1 \\
\hline

Journal de logs invalide & [Erreur 1] Le fichier à analyser n'a pas pu être ouvert. & 22 \\
\hline

Fichier au format GraphViz invalide & [Erreur 2] Le fichier dot fourni n'a pas pu être ouvert. &  \\
\hline


Heure invalide & [Erreur 3] L'heure spécifiée doit être comprise entre 0 et 23 inclus. & 26 \\
\hline


Heure non spécifiée & [Erreur 4] L'heure n'a pas été spécifiée. & 25 \\
\hline

Fichier au format GraphViz non spécifié & [Erreur 5] Le nom du fichier associé à l'option g n'a pas été spécifié. &  23 \\
\hline

Pas de journal de logs à analyser & [Erreur 6] Le nom du fichier journal n'a pas été spécifié. & 20 \\
\hline

Option inexistante & [Erreur 7] Une option spécifiée au moins n'existe pas. &  27, 28 \\
\hline

Fichier au format GraphViz invalide & [Erreur 8] Le nom du fichier associé à l'option g n'a pas été spécifié ou n'a pas la bonne extension. &  24 \\
\hline

Journal de logs invalide & [Erreur 9] Le nom du fichier journal n'a pas la bonne extension. & 21 \\
\hline
\end{tabular}}
\end{center}
